...
class InteractionTracker:
    ...
    def update(self, cups: list[dict], hand: dict, dt: float) -> list[dict]:
        ...
        for cup in cups:
            ...
            state["cup_motion_distance"] += moved_distance
            ...
            cup["cup_motion_distance"] = float(state["cup_motion_distance"])
        ...
        for cup in cups:
            ...
            used_cup_candidate = (
                ...
                or cup.get("cup_motion_distance", 0.0) > self.motion_distance_threshold
